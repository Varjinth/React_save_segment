 ...
 const NewSchemaDropdown = (props) =>{
  ...
  return (
    ...
    <div className='new-schema-container'>
        ...
        <div key={index} className='schema-dropdown-container' style={{margin:"15px" }}>
            ...
            <div className='add-schema-container'>
                ...
                {openIndex === index && <NewSchemaOption editNewSchema = {editNewSchema} elements = {array} current= {element} setOpenIndex = {setOpenIndex} />}
            </div>
